<template>
  <el-dialog :model-value="isShow" width="750px" :show-close="false" :close-on-click-modal="false"
    :before-close="handleClose" class="login-dialog-box">
    <section class="user">
      <div class="user_options-container">
        <div class="user_options-text">
          <div class="user_options-unregistered">
            <h2 class="user_unregistered-title">还没有账号？</h2>
            <p class="user_unregistered-text">为了更好的使用体验，赶紧来注册一个吧~</p>
        ...
        <div :class="['user_options-forms', { bounceRight: bounceRight, bounceLeft: bounceLeft }]">
          <div class="user_forms-login">
            ...
            <el-form ref="loginRuleFormRef" class="forms_form" :model="loginForm" :rules="loginRules">
              <fieldset class="forms_fieldset">
                <div class="forms_field">
                  <el-form-item prop="email">
                    <el-input v-model="loginForm.email" type="email" class="forms_field-input" maxlength="40"
                      placeholder="电子邮箱" @keyup.enter="login(loginRuleFormRef)" />
                  </el-form-item>
                </div>
                <div class="forms_field">
              ...
              <div class="forms_buttons">
                ...
                <el-button class="forms_buttons-action" :loading="isLoginLoading" @click="login(loginRuleFormRef)">登
                  录</el-button>
              </div>
            </el-form>
          </div>
          <div class="user_forms-signup">
            ...
            <el-form ref="registerRuleFormRef" class="forms_form" :model="registerForm" :rules="registerRules">
              <fieldset class="forms_fieldset">
                <div class="forms_field">
                  <!-- 昵称 -->
                  <el-form-item prop="name">
                    <el-input v-model="registerForm.name" type="text" maxlength="16" class="forms_field-input"
                      placeholder="昵称" @keyup.enter="register(registerRuleFormRef)" />
                  </el-form-item>
                </div>
                <div class="forms_field">
                  <!-- 邮箱 -->
                  <el-form-item prop="email">
                    <el-input v-model="registerForm.email" type="email" class="forms_field-input" maxlength="40"
                      placeholder="电子邮箱" @keyup.enter="register(registerRuleFormRef)" />
                  </el-form-item>
                </div>
                <div class="forms_field">
                  <!-- 密码 -->
                  <el-form-item prop="password">
                    <el-input v-model="registerForm.password" type="password" class="forms_field-input" placeholder="密码"
                ...
                <div class="forms_field">
                  ...
                  <el-form-item prop="surePassword">
                    <el-input v-model="registerForm.surePassword" type="password" class="forms_field-input"
                      placeholder="确认密码" @keyup.enter="register(registerRuleFormRef)" />
                  </el-form-item>
                </div>
              </fieldset>
              <div class="forms_buttons">
                <el-button class="forms_buttons-action" :loading="isRegisterLoading"
                  @click="register(registerRuleFormRef)">注 册</el-button>
              </div>
            </el-form>
          </div>
        </div>
  ...
  await formEl.validate(async (valid, fields) => {
    if (valid) {
      ...
      if (data.status === 200) {
        ...
        setUuid(); //  无感刷新页面
        saveToken('Bearer ' + data.data.token.access_token); //  本地存储token
