<template>
  <el-form-item label="日期选择:">
    <el-date-picker v-model="item.date[0]" type="month" placeholder="开始月份" :clearable="false"
      @change="handleStartDateChange" />
    -
    <el-date-picker v-model="item.date[1]" type="month" placeholder="结束月份" :clearable="false"
