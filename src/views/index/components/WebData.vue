/** * @description 网站数据展示 * @author OceanH * @date 2023/03/29 08:40:04 */
<template>
  <div class="data-show-box">
    <!-- 标题 -->
    <IntroduceTitle title="网站统计" subtitle="从网站开放以来服务用户的相关数据" title-color="#000" subtitle-color="#7f8b96"></IntroduceTitle>
    <div class="list-box">
      <ul ref="ulNumberRef">
        <li>
...
onMounted(() => {
  const { stop } = useIntersectionObserver(
    ...
    ([{ isIntersecting }]) => {
      if (isIntersecting) {
        // 当分析数据部分进入可视区域时，调用count-to的start方法开始动态滚动
